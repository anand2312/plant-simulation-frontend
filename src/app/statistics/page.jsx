...
import Chart from "../components/Statistics/Chart.js";
...
export default function StatisticsPage() {
  ...
  const stationData = Object.entries(results)
    .filter(([key]) => key !== 'log' && !key.toLowerCase().includes('source'))
    .reduce((acc, [nodeId, stats]) => {
      acc[nodeId] = {
        received: stats.parts_received,
        sent: stats.parts_sent,
      };
      return acc;
    }, {});
  ...
  return (
    <div className="p-8 max-w-5xl mx-auto">
      ...
      <div className="flex justify-center mt-4 px-4 py-2 bg-blue-500 text-white rounded ">
        <button
